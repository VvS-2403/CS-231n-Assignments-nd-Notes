...
"""
# Define imresize function
def imresize(arr, size):
    pil_image = Image.fromarray(arr)
    # Image.resize expects (width, height) tuple
    # Assuming 'size' from cs231n is typically (height, width)
    H, W = size
    return np.array(pil_image.resize((W, H), Image.BICUBIC))
